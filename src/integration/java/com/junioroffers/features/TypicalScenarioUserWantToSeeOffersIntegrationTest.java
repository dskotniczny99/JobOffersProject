...
public class TypicalScenarioUserWantToSeeOffersIntegrationTest extends BaseIntegrationTest implements SampleJobOfferResponse {
    ...
    public void user_want_to_see_offers_but_have_to_be_logged_in_and_external_server_should_have_some_offers() throws Exception {
        ...
        // given && when
        List<OfferResponseDto> nextTwoOffers = httpOffersScheduler.fetchAllOffersAndSaveAllIfNotExists();
        // then
        assertThat(nextTwoOffers).hasSize(2);
        ...
        OfferResponseDto expectedThirdOffer = nextTwoOffers.get(0);
        OfferResponseDto expectedFourthOffer = nextTwoOffers.get(1);
